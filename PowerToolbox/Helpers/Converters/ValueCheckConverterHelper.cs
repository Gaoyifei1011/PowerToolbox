...
namespace PowerToolbox.Helpers.Converters
{
    ...
    {
        internal static Visibility IsCurrentItem(SelectorBarItem selectedItem, SelectorBarItem comparedItem)
        {
        ...
        /// 检查下载任务状态
        /// </summary>
        internal static Visibility CheckDownloadProgressStateVisibility(DownloadProgressState downloadProgressState, DownloadProgressState comparedDownloadProgressState, bool needReverse)
        {
        ...
        /// 检查文件是否正在下载中
        /// </summary>
        internal static Visibility CheckDownloadingStateVisibility(DownloadProgressState downloadProgressState)
        {
        ...
        /// 检查文件解锁状态
        /// </summary>
        internal static Visibility CheckFileUnlockStateVisibility(FileUnlockState fileUnlockState, FileUnlockState comparedFileUnlockState)
        {
        ...
        /// 检查更新应用状态
        /// </summary>
        internal static Visibility CheckUpdateAppResultKindVisibility(UpdateAppResultKind updateAppResultKind, UpdateAppResultKind comparedUpdateAppResultKind)
        {
        ...
        /// 检查模拟更新类型
        /// </summary>
        internal static Visibility CheckSimulateUpdateKindVisibility(SimulateUpdateKind simulateUpdateKind, SimulateUpdateKind comparedSimulateUpdateKind)
        {
        ...
        /// 检查选择的保存图标格式
        /// </summary>
        internal static Visibility CheckIconFormatVisibility(object iconFormatKey, object comparedIconFormatKey)
        {
