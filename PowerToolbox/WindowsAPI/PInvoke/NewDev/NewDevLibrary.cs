...
namespace PowerToolbox.WindowsAPI.PInvoke.NewDev
{
    ...
    /// NewDev.dll 函数库
    /// </summary>
    internal static class NewDevLibrary
    {
        ...
        internal static extern bool DiInstallDriver(nint hwndParent, [MarshalAs(UnmanagedType.LPWStr)] string InfPath, uint Flags, out bool NeedReboot);
        ...
        internal static extern bool DiUninstallDriver(nint hwndParent, [MarshalAs(UnmanagedType.LPWStr)] string InfPath, DIURFLAG Flags, out bool NeedReboot);
    }
}
