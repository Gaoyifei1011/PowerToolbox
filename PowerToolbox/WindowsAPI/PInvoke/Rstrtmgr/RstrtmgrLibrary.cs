...
namespace PowerToolbox.WindowsAPI.PInvoke.Rstrtmgr
{
    ...
    /// Rstrtmgr.dll 函数库
    /// </summary>
    internal static class RstrtmgrLibrary
    {
        ...
        internal static extern int RmRestart(uint dwSessionHandle, RM_SHUTDOWN_TYPE dwRestartFlags, RM_WRITE_STATUS_CALLBACK fnStatus);
        ...
        internal static extern int RmShutdown(uint dwSessionHandle, RM_SHUTDOWN_TYPE lActionFlags, RM_WRITE_STATUS_CALLBACK fnStatus);
        ...
        internal static extern int RmStartSession(out uint pSessionHandle, int dwSessionFlags, [MarshalAs(UnmanagedType.LPWStr)] string strSessionKey);
        ...
        internal static extern int RmGetList(uint dwSessionHandle, out uint pnProcInfoNeeded, ref uint pnProcInfo, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] RM_PROCESS_INFO[] rgAffectedApps, out uint lpdwRebootReasons);
    }
}
