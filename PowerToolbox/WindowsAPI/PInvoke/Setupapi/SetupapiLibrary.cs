...
namespace PowerToolbox.WindowsAPI.PInvoke.Setupapi
{
    ...
    /// Setupapi.dll 函数库
    /// </summary>
    internal static class SetupapiLibrary
    {
        ...
        internal static extern bool SetupDiEnumDeviceInfo(nint deviceInfoSet, int memberIndex, ref SP_DEVINFO_DATA deviceInfoData);
        ...
        internal static extern nint SetupDiGetClassDevs(Guid ClassGuid, [MarshalAs(UnmanagedType.LPWStr)] string enumerator, nint hwndParent, DIGCF flags);
        ...
        internal static extern bool SetupDiGetDeviceProperty(nint deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, ref DEVPROPKEY propertyKey, out DEVPROP_TYPE propertyType, nint propertyBuffer, int propertyBufferSize, out int requiredSize, int flags);
        ...
        internal static extern bool SetupGetInfDriverStoreLocation([MarshalAs(UnmanagedType.LPWStr)] string FileName, nint AlternatePlatformInfo, nint LocaleName, StringBuilder ReturnBuffer, int ReturnBufferSize, out int RequiredSize);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool SetupUninstallOEMInf([MarshalAs(UnmanagedType.LPWStr)] string InfFileName, SUOI_Flags Flags, nint Reserved);
    }
}
