...
namespace PowerToolbox.WindowsAPI.PInvoke.User32
{
    ...
    internal static class User32Library
    {
        ...
        internal static extern nint CallNextHookEx(nint idHook, int nCode, nuint wParam, nint lParam);
        ...
        internal static extern bool ChangeWindowMessageFilter(WindowMessage message, ChangeFilterFlags dwFlag);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool ExitWindowsEx(EWX uFlags, SHTDN_REASON dwReason);
        ...
        internal static extern int GetWindowLong(nint hWnd, WindowLongIndexFlags nIndex);
        ...
        internal static extern int GetWindowLongPtr(nint hWnd, WindowLongIndexFlags nIndex);
        ...
        internal static extern void keybd_event(Keys bVk, byte bScan, KEYEVENTFLAGS dwFlags, nuint dwExtraInfo);
        ...
        internal static extern int MapWindowPoints(nint hWndFrom, nint hWndTo, ref Point lpPoints, uint cPoints);
        ...
        internal static extern int PrivateExtractIcons([MarshalAs(UnmanagedType.LPWStr)] string lpszFile, int nIconIndex, int cxIcon, int cyIcon, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] nint[] phicon, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] int[] piconid, int nIcons, int flags);
        ...
        internal static extern int SendMessageTimeout(nint hWnd, WindowMessage Msg, nuint wParam, nint lParam, SMTO fuFlags, uint uTimeout, out nint result);
        ...
        internal static extern nint SendMessage(nint hWnd, WindowMessage wMsg, nuint wParam, nint lParam);
        ...
        internal static extern nint SetWindowLong(nint hWnd, WindowLongIndexFlags nIndex, nint dwNewLong);
        ...
        internal static extern nint SetWindowLongPtr(nint hWnd, WindowLongIndexFlags nIndex, nint dwNewLong);
        ...
        internal static extern nint SetWindowsHookEx(HOOKTYPE idHook, HOOKPROC lpfn, nint hMod, int dwThreadId);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool SystemParametersInfo(SPI uiAction, uint uiParam, nint pvParam, SPIF fWinIni);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool UnhookWindowsHookEx(nint idHook);
    }
}
