...
namespace PowerToolbox.WindowsAPI.PInvoke.PowrProf
{
    ...
    internal struct SYSTEM_POWER_CAPABILITIES
    {
        ...
        internal byte HiberFileType;

        [MarshalAs(UnmanagedType.U1)]
        internal bool AoAcConnectivitySupported;
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U1)] internal bool BatteriesAreShortTerm;

        /// <summary>
        /// 一个BATTERY_REPORTING_SCALE结构，其中包含有关如何报告系统电池指标的信息。
        /// </summary>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        internal BATTERY_REPORTING_SCALE[] BatteryScale;

        /// <summary>
        /// 最低 系统睡眠状态 (Sx) ，当系统使用交流电源时，它将生成唤醒事件。 此成员必须是 SYSTEM_POWER_STATE 枚举类型值之一。
        /// </summary>
        internal SYSTEM_POWER_STATE AcOnLineWake;

        /// <summary>
        /// 最低 系统睡眠状态 (Sx) ，它将通过盖子开关生成唤醒事件。 此成员必须是 SYSTEM_POWER_STATE 枚举类型值之一。
        /// </summary>
        internal SYSTEM_POWER_STATE SoftLidWake;
