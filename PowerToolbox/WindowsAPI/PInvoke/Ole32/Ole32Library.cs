...
namespace PowerToolbox.WindowsAPI.PInvoke.Ole32
{
    ...
    /// Ole32.dll 函数库
    /// </summary>
    internal static class Ole32Library
    {
        ...
        internal static extern int CoSetProxyBlanket(nint proxy, uint dwAuthnSvc, uint dwAuthzSvc, nint pServerPrincName, uint dwAuthLevel, uint dwImpLevel, nint pAuthInfo, uint dwCapabilities);
    }
}
