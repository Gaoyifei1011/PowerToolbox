...
namespace PowerToolbox.Services.Position
{
    /// <summary>
    /// 设备位置服务
    /// </summary>
    public static class DevicePositionService
    {
        ...
        public static void Initialize()
        {
            ...
            {
                LogService.WriteLog(TraceEventType.Error, nameof(PowerToolbox), nameof(DevicePositionService), nameof(Initialize), 1, e);
                IsInitialized = false;
            }
        }
        ...
        public static void UnInitialize()
        {
            ...
            catch (Exception e)
            {
                IsInitialized = false;
                IsLoaded = false;
                LogService.WriteLog(TraceEventType.Error, nameof(PowerToolbox), nameof(DevicePositionService), nameof(UnInitialize), 1, e);
            }
        }
