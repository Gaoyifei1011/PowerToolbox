namespace PowerToolboxShellExtension.WindowsAPI.PInvoke.Advapi32
{
    ...
    internal class ReservedKeyHandles
    {
        ...
        /// </summary>
        internal static readonly nuint HKEY_CURRENT_USER = new(0x80000001);
        ...
        /// </summary>
        internal static readonly nuint HKEY_LOCAL_MACHINE = new(0x80000002);

        /// <summary>
        /// 从属此键的注册表项为本地计算机上的新用户定义默认用户配置，并为当前用户定义用户配置。
        /// </summary>
        internal static readonly nuint HKEY_USERS = new(0x80000003);

        /// <summary>
        /// 从属此键的注册表项允许访问性能数据。 数据实际上未存储在注册表中;注册表函数会导致系统从其源收集数据。
        /// </summary>
        internal static readonly nuint HKEY_PERFORMANCE_DATA = new(0x80000004);
        ...
        /// </summary>
        internal static readonly nuint HKEY_CURRENT_CONFIG = new(0x80000005);

        /// <summary>
        /// HKEY_DYN_DATA是windows 95、windows 98（98se）、windows me以上三种windows操作系统的注册表当中所特有的一个主键。
        /// </summary>
        internal static readonly nuint HKEY_DYN_DATA = new(0x80000006);
        ...
        /// </summary>
        internal static readonly nuint HKEY_CURRENT_USER_LOCAL_SETTINGS = new(0x80000007);

        /// <summary>
        /// 从属此键的注册表项引用描述美国英语计数器的文本字符串。 这些条目不适用于Regedit.exe和Regedt32.exe。Windows 2000：不支持此密钥。
        /// </summary>
        internal static readonly nuint HKEY_PERFORMANCE_TEXT = new(0x80000050);

        /// <summary>
        /// 从属于此键的注册表项引用文本字符串，这些字符串描述计算机系统所在区域的本地语言的计数器。 这些条目不适用于Regedit.exe和Regedt32.exe。Windows 2000：不支持此密钥。
        /// </summary>
        internal static readonly nuint HKEY_PERFORMANCE_NLSTEXT = new(0x80000060);
    }
}
